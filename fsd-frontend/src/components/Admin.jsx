...
const Admin = () => {
    return (
        <section className="container my-5" style={{marginLeft:"300px"}}>
            <div className="row justify-content-center align-items-center">
                <div className="col-lg-8 text-center">
                <h2 className="display-5 mb-4">Welcome to Admin Panel !!!</h2>
                ...
                <div className="col-md-6">
                    <div className="card mb-4">
                        <div className="card-body text-center">
                            ...
                            <p className="card-text">Start building a new quiz.</p>
